...
+ 設定和管理 {#setup-and-admin}
   ...
   + 使用情況和帳單 {#usage-and-billing}
      + [監控及報告活動使用情況](setup-and-admin/usage-and-billing/monitoring-and-reporting-on-activity-usage.md)
...
+ Audience Marketplace {#audience-marketplace}
   + 購買資料 {#buying-data}
      + [在區段層級報告Audience Marketplace中的第二方和第三方資料使用量](audience-marketplace/buying-data/reporting-2nd-and-3rd-party-data-usage-in-the-audience-marketplace-at-the-segment-level.md)
      + [將資料使用情況大量上傳至Audience Marketplace](audience-marketplace/buying-data/bulk-uploading-data-usage-into-the-audience-marketplace.md)
...
+ 建立和管理對象 {#build-and-manage-audiences}
   + 資料總管 {#data-explorer}
      + [使用訊號儀表板快速檢視最常用的訊號](build-and-manage-audiences/data-explorer/using-the-signals-dashboard-to-quickly-view-top-available-signals.md)
   ...
   + 特徵和區段 {#traits-and-segments}
      + [規劃以Analytics資料建立特徵](build-and-manage-audiences/traits-and-segments/planning-trait-creation-from-analytics-data.md)
      ...
      + [使用存留時間(TTL)設定設定特徵到期時間](build-and-manage-audiences/traits-and-segments/configuring-trait-expiration-with-the-time-to-live-ttl-setting.md)
      ...
      + [實用的區段定義與建立](build-and-manage-audiences/traits-and-segments/practical-segment-definition-and-creation.md)
      ...
      + [透過特徵建議增強您的區段](build-and-manage-audiences/traits-and-segments/enhancing-your-segments-with-trait-recommendations.md)
   ...
   + 演演算法模型 {#algorithmic-models}
      ...
      + [設定和報告於 [!UICONTROL Predictive Audiences]](build-and-manage-audiences/algorithmic-models/configure-and-report-on-predictive-audiences.md)
      + [建立第一方相似模型](build-and-manage-audiences/algorithmic-models/creating-a-first-party-look-alike-model.md)
      + [在演演算法（相似）模型中排除特徵](build-and-manage-audiences/algorithmic-models/excluding-traits-in-algorithmic-look-alike-models.md)
      + [使用演演算法（相似）模型增加ROAS](build-and-manage-audiences/algorithmic-models/increase-roas-by-using-algorithmic-look-alike-models.md)
      + [使用相似模型，從第一方資料擴充已售出存貨](build-and-manage-audiences/algorithmic-models/using-look-alike-models-to-extend-sold-out-inventory-from-your-1st-party-data.md)
   + 設定檔合併 {#profile-merge}
      + [配置文件合并规则](build-and-manage-audiences/profile-merge/profile-merge.md)
      + [設定檔合併規則概要](build-and-manage-audiences/profile-merge/overview-of-profile-merge-rules.md)
      ...
      + [使用設定檔合併規則進行裝置延伸和增加觸及率](build-and-manage-audiences/profile-merge/using-profile-merge-rules-for-device-extension-and-increased-reach.md)
      ...
      + [解讀對象身分報告](build-and-manage-audiences/profile-merge/interpret-audience-identity-reporting.md)
...
+ 資料啟用 {#data-activation}
   ...
   + 以人物為基礎的目的地 {#people-based-destinations}
      ...
      + [使用setCustomerIDs()將PII擷取並雜湊為宣告ID](data-activation/people-based-destinations/using-setcustomerids-to-ingest-and-hash-pii-as-a-declared-id.md)
      ...
      + [瞭解並設定Google客戶相符的People-based目的地](data-activation/people-based-destinations/understanding-and-configuring-the-google-customer-match-pbd.md)
+ 报告 {#reports}
...
+ 其他整合 {#other-integrations}
   + 整合Real-time Customer Data Platform {#integrating-with-rtcdp}
      ...
      + [瞭解Real-time CDP中的Web資料擷取](other-integrations/integrating-with-rtcdp/rtcdp-web-ingestion-for-aam-users.md)
